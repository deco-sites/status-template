...
export default function Section ({ title, subtitle }: Props) {
//cor manipulavel pelo admin de acordo com o nivel do status ou feature
  return (
    <div className="w-full space-y-2 flex justify-center items-center flex-col border border-gray-200 rounded">
      <div className="w-full p-5 flex items-center gap-2 bg-gradient-to-r from-green-200 from-10% to-green-100 to-90%">
